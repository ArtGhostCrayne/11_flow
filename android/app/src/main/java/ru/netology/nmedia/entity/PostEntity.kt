...
data class PostEntity(
    ...
    companion object {
        fun fromDto(dto: Post, newPost: Boolean) =
            PostEntity(dto.id, dto.authorId, dto.author, dto.authorAvatar, dto.content, dto.published, dto.likedByMe, dto.likes , newPost = newPost, AttachmentEmbeddable.fromDto(dto.attachment))
